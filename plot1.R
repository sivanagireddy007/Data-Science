# plot1.R is to draw histogram with Global_active_power of house hold power consumption data 
...
# plot 1 - histogram
par(mfrow = c(1, 1))
hist(household_consumption_data$Global_active_power,main = "Global Active Power", 
